...
const DATACENTERS = (() => {
  ...
  const DC_DATA = [
    ...
    { name: 'Equinix DC (Ashburn)',         lat: 39.04, lon: -77.49, tier: 2, operator: 'Equinix',         traffic: 'Top 5 global by IX traffic' },
    ...
    { name: 'Equinix Los Angeles (LA)',     lat: 34.05, lon: -118.24, tier: 2, operator: 'Equinix',        traffic: 'Major IX hub' },
    ...
    { name: 'Equinix San Jose (SV)',        lat: 37.34, lon: -121.89, tier: 2, operator: 'Equinix',        traffic: 'Top IX hub, Silicon Valley' },
    ...
    { name: 'Equinix Frankfurt (FR)',       lat: 50.10, lon: 8.65,  tier: 2, operator: 'Equinix',         traffic: 'Top 3 global IX (DE-CIX)' },
    { name: 'DE-CIX Frankfurt',            lat: 50.12, lon: 8.71,  tier: 2, operator: 'DE-CIX',          traffic: 'Largest IX by traffic globally' },
    { name: 'Azure West Europe (Amsterdam)',lat: 52.37, lon: 4.90,  tier: 1, operator: 'Microsoft Azure',  traffic: 'Tier 1 — Hyperscale' },
    { name: 'AMS-IX Amsterdam',            lat: 52.37, lon: 4.89,  tier: 2, operator: 'AMS-IX',          traffic: 'Top 2 global IX' },
    ...
    { name: 'LINX London',                 lat: 51.51, lon: -0.11, tier: 2, operator: 'LINX',             traffic: 'Major European IX' },
    ...
    { name: 'STC Riyadh',                  lat: 24.70, lon: 46.73, tier: 2, operator: 'STC',              traffic: 'KSA hub' },
    ...
    { name: 'Equinix Singapore (SG)',       lat: 1.36,  lon: 103.82, tier: 2, operator: 'Equinix',        traffic: 'Top APAC IX hub' },
    { name: 'SGIX Singapore',              lat: 1.35,  lon: 103.81, tier: 2, operator: 'SGIX',            traffic: 'APAC IX' },
    ...
    { name: 'JPIX Tokyo',                  lat: 35.70, lon: 139.71, tier: 2, operator: 'JPIX',            traffic: 'Japan IX' },
    ...
    { name: 'KT Cloud Seoul',              lat: 37.55, lon: 126.96, tier: 2, operator: 'KT Corp',         traffic: 'Korea hub' },
    ...
    { name: 'HKIX Hong Kong',              lat: 22.31, lon: 114.16, tier: 2, operator: 'HKIX',            traffic: 'HK IX' },
    ...
    { name: 'Teraco Johannesburg',          lat: -26.12,lon: 28.07,  tier: 2, operator: 'Teraco',          traffic: 'Africa top hub' },
    { name: 'IXPN Lagos',                  lat: 6.52,  lon: 3.37,   tier: 3, operator: 'IXPN',            traffic: 'Nigeria IX' },
    { name: 'KIXP Nairobi',                lat: -1.30, lon: 36.82,  tier: 3, operator: 'KIXP',            traffic: 'East Africa IX' },
    ...
    { name: 'PTT-Telesp IX (Sao Paulo)',    lat: -23.54,lon: -46.63, tier: 2, operator: 'NIC.br',         traffic: 'Brazil IX' },
